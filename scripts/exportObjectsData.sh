#!/bin/sh
## Description: Description: This bat file used to export aLL IPM NG project Salesforce custom objects data using ANT Targets
## Usage: Called from ANT/Jenkins Jobs
## Note : Below Data extraction scripts need to be executed in sequence as mentioned below
