var loextpromotiongridmock = {
    getMeta: function () {

        var result = {
            '__Model': 'LOExtPrdFilters',
            '__Status': true,
            'data': {
                "axis": {"x": "Week", "y": ["measures", "Tactic", "Product"]},
                "measures": [{
                    "name": "Baseline",
                    "code": "BASE",
                    "type": "read",
                    "datasource": {"tablename": "weeklymeasureint", "measurecode": "BASE", "weekoffset": 0},
                    "aggregation": {"rule": "sum", "skippeddimensions": ["Tactic"]},
                    "display": {"enabled": true, "round": 0},
                    "totalcalculation": {"rule": "sum"}
                }, {
                    "name": "TacticBaseline",
                    "code": "BL03",
                    "display": {"enabled": true, "round": 0},
                    ...
                    "code": "CNST",
                    "type": "calculated",
                    "aggregation": {"rule": "sum", "skippeddimensions": []},
                    "computed": true,
                    "formula": "()=> { return 1; }",
                    "display": {"enabled": false, "round": 2},
                    "totalcalculation": {"rule": "sum"}
                }, {
                    "name": "Shipment",
                    "code": "SHIP",
                    "type": "read",
                    "datasource": {"tablename": "weeklymeasureint", "measurecode": "SHIP", "weekoffset": 0},
                    "aggregation": {"rule": "sum", "skippeddimensions": ["Tactic"]},
                    "display": {"enabled": false, "round": 0},
                    "totalcalculation": {"rule": "sum"}
                }, {
                    "name": "LYShipment",
                    "code": "LYSH",
                    "type": "read",
                    "datasource": {"tablename": "weeklymeasureint", "measurecode": "SHIP", "weekoffset": 52},
                    "aggregation": {"rule": "sum", "skippeddimensions": ["Tactic"]},
                    "display": {"enabled": false, "round": 0},
                    "totalcalculation": {"rule": "sum"}
                }, {
                    ...
                    "code": "CONS",
                    "type": "read",
                    "datasource": {"tablename": "weeklymeasureint", "measurecode": "CONS", "weekoffset": 0},
                    "aggregation": {"rule": "sum", "skippeddimensions": ["Tactic"]},
                    "display": {"enabled": false, "round": 0},
                    "totalcalculation": {"rule": "sum"}
                }, {
...
module.exports = loextpromotiongridmock;
