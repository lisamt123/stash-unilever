...
module.exports = new React.createClass({
    displayName: 'ProductGroupOverview',
    ...
    componentWillReceiveProps: function (nextProps) {
        var me = this;
        PromotionService.getAggregatedKPIforItem(nextProps.item.id, 'productGroup', ['inc_costs_actual', 'inc_costs_planned', 'inc_sales_actual', 'inc_sales_planned'], function (data) {
    ...
    componentDidMount: function (nextProps) {
        var me = this;
        PromotionService.getAggregatedKPIforItem(this.props.item.id, 'productGroup', ['inc_costs_actual', 'inc_costs_planned', 'inc_sales_actual', 'inc_sales_planned'], function (data) {
            me.setState({aggregatedData: data})
        });
    },
    ...
    render: function () {
        return (<div className="slds-grid slds-wrap slds-size--2-of-3 graphSection">
            <div className="slds-col--padded-left slds-size--1-of-2">
                <Tile key='tile31' animated={false}>
                    <LineChart
