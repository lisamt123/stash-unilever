...
module.exports = React.createClass({
    ...
    toggleProduct: function (product) {
        ...
        var confirmMessage = {
            title: 'Confirmation',
            message: 'Do you want to exclude the product?',
    ...
    render: function () {
        ...
        return (
            <div className="tile">
                <div
                    className="slds-form-element__label">{AppManager.getLabel('PP_TIT_TACTIC_INFO') || 'Tactic Information'}</div>
                ...
                <div className="slds-grid ">
                    <div className="slds-col--padded-right slds-size--1-of-3">
                        ...
                        <div className="slds-m-top--medium"/>
                        <Variant object={this.state.tactic} field="Amount__c"   onValueChange={this.onFieldChange}  editable={this.props.editMode }/>
                     </div>
                    <div className="slds-col--padded slds-size--1-of-3">
                        <div className="slds-grid ">
                            <div className="slds-col--padded-right">
                                <Variant object={this.state.tactic} field="Lift__c"   onValueChange={this.onFieldChange}  editable={this.props.editMode }/>
                            </div>
                            <div className="slds-col">
                                <Variant object={this.state.tactic} field="Pct_of_Stores__c"   onValueChange={this.onFieldChange}  editable={this.props.editMode }/>
                            </div>
                        </div>
                        <div className="slds-grid slds-m-top--medium">
                            <div className="slds-col--padded-right">
                                 <Variant object={this.state.tactic} field="Date_From__c"   onValueChange={this.onFieldChange}  editable={this.props.editMode }/>
                            </div>
                            <div className="slds-col">
                                 <Variant object={this.state.tactic} field="Date_Thru__c"   onValueChange={this.onFieldChange}  editable={this.props.editMode }/>
                           </div>
                        </div>
{/* soco start */}
                    <div className="slds-grid slds-m-top--medium">
...
{/* soco start */}
                    ...
                    <div className="slds-col--padded slds-size--1-of-3">
                        <Variant object={this.state.tactic} field="Compensation_Model__c"   onValueChange={this.onFieldChange}  editable={this.props.editMode }/>
                        <div className="slds-m-top--medium"/>
                        <Variant object={this.state.tactic} field="Payment_Method__c"   onValueChange={this.onFieldChange}  editable={this.props.editMode }/>
                    </div>
                </div>
                <div className="slds-m-top--medium"></div>
                {(!this.props.editMode) ? null : <div className="slds-grid">
