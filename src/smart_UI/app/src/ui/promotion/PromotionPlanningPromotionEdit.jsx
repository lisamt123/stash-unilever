...
var ACLCheck = require('../components/ACLCheck'); //API_TPM-1499
...
module.exports = React.createClass({
    ...
    render: function () {
        if (this.state.promotion == null) {
            ...
            return (
                <div>{/*MAIN DIV - Do Not Remove*/}
                    <ACLCheck object={this.props.promotion} field="TILE_PROMO_MAIN_SOCO">
                        {/* API - TPM-XXXX SoCo Promotion Layout */}
                        <div className="tile" >
                            <div className="slds-grid title">{AppManager.getLabel('PP_LBL_MAIN_ID') || 'Promotion ID'}</div>
                            <div className="slds-grid ">
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4">
                                    <div className="slds-m-top--medium" />
                                    <div className="slds-col">
                                        <Variant object={this.state.promotion} field="Slogan__c"
                                            onValueChange={this.onFieldChange} editable={this.props.editMode} />
                                    </div>
                                </div>
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4 slds-col--padded-left">
                                    <div className="slds-m-top--medium" />
                                    <div className="slds-col">
                                        <Variant object={this.state.promotion} field="Anchor_Account__c"
                                            onValueChange={this.onFieldChange} editable={this.props.editMode} />
                                    </div>
                                </div>
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4 slds-col--padded-left">
                                ...
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4 slds-col--padded-left--xs slds-col--padded-left slds-m-top--large">
                                    <div className="slds-m-top--medium" />
                                    <div className="slds-col">
                    ...
                    <ACLCheck object={this.props.promotion} field="TILE_PROMO_MAIN_SOCO">
                        <div className="tile  slds-m-top--medium" >
                            <div className="slds-grid title">{AppManager.getLabel('PP_LBL_MAIN_DETAILS') || 'Promotion Details'}</div>
                            <div className="slds-grid ">
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4">
                                    <div className="slds-m-top--medium" />
                                    <div className="slds-col">
                                ...
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4 slds-col--padded-left">
                                    ...
                                    <div className="slds-col">
                                        <Variant object={this.state.promotion} field="UL_Volume_Type__c"
                                                onValueChange={this.onFieldChange} editable={this.props.editMode} />
                                        <div className="slds-m-top--medium" />
                                        <Variant object={this.state.promotion} field="UL_IIBB_Tax__c"
                                            onValueChange={this.onFieldChange} editable={this.props.editMode} />
                                    </div>
                                </div>
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4 slds-col--padded-left">
                                ...
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4 slds-col--padded-left--xs slds-col--padded-left slds-m-top--large">{/* to be checked*/}
                                    <div className="slds-m-top--medium" />
                                    <div className="slds-col">
					...
					<ACLCheck object={this.props.promotion} field="TILE_PROMO_MAIN_SOCO">
                        <div className="tile  slds-m-top--medium" >
                            <div className="slds-grid title">{AppManager.getLabel('PP_LBL_MAIN_DATES') || 'Promotion Dates'}</div>
                            <div className="slds-grid ">
                    ...
                    <ACLCheck object={this.props.promotion} field="TILE_PROMO_MAIN_CORE">
                        <div className="tile">
                            ...
                            <div className="slds-grid">
                                ...
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-3 slds-col--padded-left--xs slds-col--padded-right ">
                                    <div className="slds-m-top--medium" />
                                    <div className="slds-col--padded-right">
                    ...
                    <ACLCheck object={this.props.promotion} field="TILE_PROMO_MAIN_UKI">
                        {/* API - TPM-1499 UKI Promotion Layout */}
                        <div className="tile" >
                            <div className="slds-grid title">{AppManager.getLabel('PP_LBL_MAIN_ID') || 'Promotion ID'}</div>
                            <div className="slds-grid ">
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4">
                                ...
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4 slds-col--padded-left">
                                    <div className="slds-m-top--medium" />
                                    <div className="slds-col">
                                        <Variant object={this.state.promotion} field="UL_Promotion_ID__c"
                                            onValueChange={this.onFieldChange} editable={this.props.editMode} />
                                    </div>
                                </div>
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4 slds-col--padded-left">
                                ...
                                <div className="slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-4 slds-col--padded-left--xs slds-col--padded-left">{/* to be checked*/}
                                    <div className="slds-m-top--medium" />
                                    <div className="slds-col">
                                        <Variant object={this.state.promotion} field="Anchor_Account__c"
                                            onValueChange={this.onFieldChange} editable={this.props.editMode} />
