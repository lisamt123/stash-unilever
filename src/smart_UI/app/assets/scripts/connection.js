...
sforce.internal.Debug = function() {
    ...
    this.println = function(s, type) {
        ...
        if (this.win === null || !this.win.document) {
            this.output = null;
            this.win = window.open((typeof window.UserContext != "undefined") ? UserContext.getUrl('/soap/ajax/38.0/debugshell.html') : '/soap/ajax/38.0/debugshell.html', '',
...
sforce.Transport = function(url) {
    ...
    this.send = function (envelope, callback, async, timeout) {
        ...
        this.connection.open("POST", `https://${window.VF_REMOTING_HOST}${this.url || ''}`, async);
...
sforce.Connection = function() {
    ...
    this.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/services/Soap/u/38.0") : "/services/Soap/u/38.0";
};
...
sforce.Connection.prototype.remoteFunction = function(args) {
    ...
    request.open(args.method, `https://${window.VF_REMOTING_HOST}${proxyUrl || ''}`, args.async);
...
sforce.connection.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/services/Soap/u/38.0") : "/services/Soap/u/38.0";
