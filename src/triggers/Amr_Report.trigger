trigger Amr_Report on Amr_Job_Details__c (after insert, after update) {
   ...
   List<Amr_Job_Details__c> jobDetailList = [select ProductCategory__r.name,id,Project_Location_Cluster__c,Function_You_Are_Part__c,CreatedDate from Amr_Job_Details__c ];
