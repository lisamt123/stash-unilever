/***************************************************************
    Name: UL_PromotionTrigger
    Copyright: Accenture
    ======================================================
    Purpose:
    Trigger on Promotion Object
    ======================================================
    History
    -------
    VERSION     AUTHOR         DATE             DETAIL                 Description
    1.0         Badari         29/11/2016       Initial Development    Handles Promotion before insert/update/delete and after insert/update events
    ***************************************************************/
    ...
    public final String STATUS_END_DATE = 'End Date' ;
        if(UL_Utility.IS_PROMOTION_TRIGGER_ENABLED){
            if(trigger.isBefore){
              if(trigger.isUpdate){
