...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>ar_Experience__c-Project Layout</layout>
    ...
    <layoutAssignments>
        <layout>ar_Fixed_Price_Rate_Card__c-Fixed Price Rate Card Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ar_Fixed_Price_Rate_Card__c-Fixed Price Rate Card Layout</layout>
    ...
    <layoutAssignments>
        <layout>ar_Insurance_and_Policy__c-Insurance Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ar_Insurance_and_Policy__c-Insurance Layout</layout>
    ...
    <layoutAssignments>
        <layout>ar_Insurance_and_Policy__c-Trade and Regulatory Bodies Layout</layout>
