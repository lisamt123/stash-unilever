({
    doSearch : function(component, event, helper) {
        ...
        action.setAbortable();
        // Set the parameters
        action.setParams({ "searchString" : searchString.substring(1, searchString.length), "sObjectAPIName" : "User","recordType":"null", "eventId":component.get("v.Participant_Event")});
        // Define the callback
