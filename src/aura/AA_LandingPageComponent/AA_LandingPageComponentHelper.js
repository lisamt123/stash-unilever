({
	getAllData : function(component) {
       console.log("called getAllData method request param:====>"+ component.get("v.countryId") + '==>'+component.get("v.clusterId"));
       ...
       var actionResult = component.get("c.getRetriveAllAgentReports");
		...
		actionResult.setCallback(this, function(a) {
            if (a.getState() === "SUCCESS") {
                console.log("Result Data:====>"+JSON.stringify(a.getReturnValue()));
