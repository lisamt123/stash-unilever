...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>CN21_CSBFALSE_Foreign_MBS</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">AM_V-MAR MEDI_VENDOR-MARKETING&amp;MEDIA</value>
    </values>
    <values>
        <field>VPM_CompanyCode__c</field>
        <value xsi:type="xsd:string">CN21</value>
    </values>
    <values>
        <field>VPM_PaymentMethod1__c</field>
        <value xsi:type="xsd:string">O _Electronic Bank Transfer Overs</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">14301013</value>
    </values>
    <values>
        <field>VPM_SortKey__c</field>
        <value xsi:type="xsd:string">010_Purchase order no.</value>
    </values>
    <values>
        <field>VPM_ToleranceGroup__c</field>
        <value xsi:type="xsd:string">AP01</value>
    </values>
    <values>
