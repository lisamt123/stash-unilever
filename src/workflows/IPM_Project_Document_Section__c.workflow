...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>IPM_Send_an_email_to_PL</fullName>
        <description>IPM Send an email to PL(record owner)</description>
        ...
        <template>unfiled$public/IPM_Section_edit_notification_for_PL</template>
    </alerts>
    <fieldUpdates>
    ...
    <rules>
        ...
        <actions>
            <name>IPM_Send_an_email_to_PL</name>
            <type>Alert</type>
        </actions>
        <actions>
