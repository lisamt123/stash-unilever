...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>VPM_Rework</fullName>
        <description>VPM - Used to send after rework</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
...
|| ( AND(ISCHANGED(VPM_IsVendorSME__c),ISPICKVAL(VPM_IsVendorSME__c,&quot;No&quot;))&amp;&amp; ISPICKVAL(  VPM_CompanyCode__r.ECC__c  ,&quot;Fusion&quot;))</formula>
    ...
    <rules>
        ...
        <formula>(ISBLANK(TEXT(VPM_IsVendorSME__c)) &amp;&amp; ISBLANK( TEXT(VPM_PaymentTerms__c )) &amp;&amp; ISPICKVAL(  VPM_CompanyCode__r.ECC__c  ,&quot;U2K2&quot;))
|| ( AND(ISCHANGED(VPM_IsVendorSME__c),ISPICKVAL(VPM_IsVendorSME__c,&quot;No&quot;))&amp;&amp; ISPICKVAL(  VPM_CompanyCode__r.ECC__c  ,&quot;U2K2&quot;))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
