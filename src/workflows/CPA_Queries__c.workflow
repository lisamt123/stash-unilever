...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>CNF_ownership_assignment_Notification</fullName>
        <description>CNF ownership assignment Notification</description>
        ...
        <template>CPA_Email_Template/CPA_CNF_Query_Reassigned</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>TNF_Ownership_Assignment_Notification</fullName>
        <description>TNF Ownership Assignment Notification</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
        ...
        <senderType>CurrentUser</senderType>
        <template>CPA_Email_Template/CPA_TNF_Query_Reassigned</template>
    </alerts>
    <alerts>
    ...
    <rules>
        <fullName>CPA CNF Query Reassignment Notification</fullName>
        <actions>
            <name>CNF_ownership_assignment_Notification</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <formula>(    CNF_ID__c     &lt;&gt; null) &amp;&amp;  ISCHANGED( OwnerId)</formula>
    ...
    <rules>
        <fullName>CPA TNF Query Reassignment Notification</fullName>
        <actions>
            <name>TNF_Ownership_Assignment_Notification</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <formula>(     TNF_ID__c     &lt;&gt; null) &amp;&amp;  ISCHANGED( OwnerId)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
