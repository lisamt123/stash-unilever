...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>FS_TPRRejectionAction</fullName>
        <description>TPR Rejection Action</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>FS_Email_Templates/FS_TPR_Opportunity_Rejection_Action_Email_Template</template>
    </alerts>
    <alerts>
    ...
    <fieldUpdates>
        ...
        <literalValue>03 - Proposal</literalValue>
